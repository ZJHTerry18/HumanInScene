...
def init_llama_model(config):
    ...
    if config.pretrained_path:
        ...
        llama_config.save_path = config.logger.warning(f"load LLM config from {self.config['general']['save_dir']}" )
    else:
        print('*****************************************************************')
        print('*****************************************************************')
    ...
    if llama_config.enable_llm:
        ...
        if llama_config.vicuna_version == "TinyLlama-1.1B-intermediate-step-1195k-token-2.5T" or llama_config.vicuna_version == "Tiny-Vicuna-1B":
            ...
            llama_config.vicuna_weight_path = ["/home/zhaojiaohe/pretrained_models/vicuna-7b-v1.5/pytorch_model-00001-of-00002.bin",
                                               "/home/zhaojiaohe/pretrained_models/vicuna-7b-v1.5/pytorch_model-00001-of-00002.bin"]

...
def parse_args():
    ...
    parser.add_argument('--scannet_dir', type=str, default="/home/zhaojiaohe/data/zhaojiahe/HIS_dataset/PROX/scenes",
    ...
    parser.add_argument('--segment_dir', default="/home/zhaojiaohe/data/zhaojiahe/HIS_dataset/PROX/scenes", type=str,

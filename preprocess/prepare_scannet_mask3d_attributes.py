...
torch.save(scans, os.path.join(output_dir, f"hisbench_{args.segmentor}_val_attributes{args.version}.pt"))
# torch.save(scans, os.path.join(output_dir, f"trumans_{args.segmentor}_train_attributes{args.version}.pt"))
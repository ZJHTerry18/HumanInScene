...
class BaseDataset(Dataset):
    ...
    def prepare_scene_features(self):
        ...
        for scan_id in scan_ids:
            ...
            obj_num = min(scene_attr['locs'].shape[0], self.max_obj_num)
            ...
            scene_obj_labels[scan_id] = obj_labels[:obj_num]
        return scene_feats, scene_img_feats, scene_masks, scene_obj_labels

    def get_scene_anno(self, index):
        ...
        scene_obj_labels = self.scene_obj_labels[scene_id] if self.scene_obj_labels is not None else ["object"] * scene_feat.shape[0]
        scene_locs = scene_locs[:scene_feat.shape[0]]
        ...
        return scene_id, scene_feat, scene_img_feat, scene_mask, scene_locs, scene_obj_labels, assigned_ids
